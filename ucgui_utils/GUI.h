...
extern  GUI_FONT GUI_FontHZ24;
extern  GUI_FONT GUI_FontHZ32;
...
#define GUI_DRAWMODE_HalfTRANS LCD_DRAWMODE_HalfTRANS
...
#define GUI_DM_HalfTRANS LCD_DRAWMODE_HalfTRANS
...
struct GUI_CONTEXT {
	...
	U8 AA_HiResEnable;
#endif
	//following add by zhongwb
	U32 bmp_trans_flag; // for 16bpp image tansparency
	U32 bmp_trans_value;// for 16bpp image tansparency
	U8 alfaBlend;//param for half transparency
};
